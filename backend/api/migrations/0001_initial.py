# Generated by Django 4.0.3 on 2022-04-07 23:18
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('flight_num', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.flight')),
            ],
            options={
                'db_table': 'fare',
            },
        ...
        migrations.AddField(
            model_name='company',
            name='a_email',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='api.airportadmin'),
        ),
        migrations.CreateModel(
