# Generated by Django 4.0.3 on 2022-04-08 03:42
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('name', models.CharField(max_length=255, primary_key=True, serialize=False)),
                ('admin', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='api.airportadmin')),
            ],
            options={
                'db_table': 'company',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fare', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.fare')),
                ('passenger', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='api.passenger')),
            ],
            options={
                'db_table': 'ticket',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('transac', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='api.transaction')),
            ],
            options={
                'db_table': 'stay',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('plane', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='api.airplane')),
            ],
            options={
                'db_table': 'flight',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('complaint_id', models.PositiveIntegerField(primary_key=True, serialize=False)),
                ('description', models.TextField()),
                ('admin', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='api.airlineadmin')),
                ('airline_name', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.airline')),
                ('passenger', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.passenger')),
            ],
            options={
